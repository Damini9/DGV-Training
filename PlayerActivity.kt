...
//
//        val audioViewModel:AudioViewModel=ViewModelProvider(this).get(AudioViewModel::class.java)
//
//
...
class PlayerActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_player)
        val mediaPlayerViewModel:AudioViewModel= ViewModelProvider(this).get(AudioViewModel::class.java)
        ...
        fun activity(song:Song) {
            ...
            singleTitle.text = song.title
            seekBar.progress = 0
            var seekBarmax = mediaPlayer!!.duration
